...
- 답: 현재 브랜치는 develop, 마지막 커밋은 a1s2d3f, 이 커밋은 docs 브랜치에 readme를 추가한 것이다.
...
- 답: revert를 사용할 것이다. 기존의 작업을 반대로 돌리는 새 커밋을 만들어 내기 때문. 이력을 확인 할 수 있다. (누가 언제 했는지) reset은 이름부터 느낌상 누르면 안될 것 같다.(초기화) 
